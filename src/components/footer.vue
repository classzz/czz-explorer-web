        ...
        <div>
          ...
          <p class="classzz-language" @click="changeLanguage">
            ...
            ><span :class="lan == 'en' ? 'active borderr4' : 'borderr4'"
              >英</span
            >
            <!-- <span v-if="lan == 'zh'" class="bann-zh-line"></span
          ><span v-if="lan == 'en'" class="bann-en-line"></span
          > -->
          </p>
        </div>
        <div>
          <p>{{$t('footer.footerContent')}}</p>
        </div>
      </div>
    </div>
  </div>
